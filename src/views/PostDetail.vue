<template>
  <div class="post-detail-page d-flex">
    ...
    <article class="container w-75 p-4 card mt-3 shadow-sm" v-if="currentPost">
      <h2 class="mb-4" style="font-weight: bold">{{ currentPost.title }}</h2>
      <div class="user-profile-component py-3 mb-5 align-items-center row g-0">
        ...
        <span class="text-muted col text-right font-italic">{{ getFormatData(currentPost.createdAt) }}</span>
      </div>
